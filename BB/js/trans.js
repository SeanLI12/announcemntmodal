...
const translationData = [
  {
    ...
    id: "APA ITU PEMBUAT TARUHAN",
    th: "ใหม่! สร้างบิลสเต็ปได้ในแมทช์เดียว",
    ko: "베팅빌더를 소개합니다",
    pt: "APRESENTANDO O BET BUILDER",
...
const animationTranslationData = [
  {
    ...
    id: "Pilih pertandingan dan cari tab Pembuat Taruhan.",
    th: "เพียงเลือกแมทช์ที่ต้องการและกดปุ่ม สร้างบิลสเต็ป",
    ko: "경기를 선택하고 베팅빌더 탭을 확인하세요. ",
    pt: "Selecione uma partida e procure a guia Bet Builder.",
